...
import com.lfd.soa.demo.srv.support.mq.bean.RabbitServiceProfile;
...
public class RabbitServiceRegister {
    ...
    private void initServiceBean(Class<?> serviceClazz) {
        ...
        if (!beanFactory.containsBean("rabbitListenerContainerFactory")) {
            registerBean("rabbitListenerContainerFactory", getSimpleRabbitListenerContainerFactory(cachingConnectionFactory, messageConverter));
        }
