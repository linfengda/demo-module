package com.lfd.soa.srv.demo.support.schedule.task;

import com.lfd.soa.srv.demo.util.SpringUtil;
import com.lfd.soa.srv.demo.support.redis.lock.RedisDistributedLock;
import com.lfd.soa.srv.demo.support.schedule.scanner.JobMappingScanner;
import com.lfd.soa.srv.demo.support.schedule.task.bean.JobCell;
import com.lfd.soa.srv.demo.support.schedule.task.bean.JobPublishMsg;
import com.lfd.soa.srv.demo.support.schedule.task.bean.JobState;
import com.lfd.soa.srv.demo.support.schedule.task.bean.JobTaskFuture;
...
public class TaskSchedulingJobConfig {
    ...
    public static void initTask() {
        try {
            ...
            log.info("初始化所有定时任务成功！");
        } catch (Exception e) {
            log.error("初始化所有定时任务失败！", e);
        }
    }
