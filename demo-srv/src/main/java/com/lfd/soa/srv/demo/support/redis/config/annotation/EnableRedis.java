package com.lfd.soa.srv.demo.support.redis.config.annotation;

import com.lfd.soa.srv.demo.support.redis.config.selector.RedisConfigSelector;
...
/**
 * 开启redis，自动引入redisTemplate，redisDistributedLock，redis缓存等
 * @author linfengda
