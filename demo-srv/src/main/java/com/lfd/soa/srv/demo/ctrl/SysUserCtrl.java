...
public class SysUserCtrl {
    ...
    public Result updateUserInfo(@ApiValidator @RequestBody UserUpdateReq userUpdateReq) throws Exception {
        sysUserService.updateUserInfo(userUpdateReq.getUserId(), userUpdateReq);
        return new Result();
    }
