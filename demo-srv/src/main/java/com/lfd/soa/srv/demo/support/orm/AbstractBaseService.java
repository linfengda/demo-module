...
import com.lfd.soa.srv.demo.support.orm.entity.ConditionParam;
import com.lfd.soa.srv.demo.support.orm.entity.PageResult;
import com.lfd.soa.srv.demo.support.orm.entity.SetValue;
import com.lfd.soa.srv.demo.support.orm.sql.builder.PreStatementSql;
import com.lfd.soa.srv.demo.support.orm.sql.builder.PreStatementSqlBuilder;
import com.lfd.soa.srv.demo.support.orm.sql.handler.PreStatementSqlHandler;
import com.lfd.soa.srv.demo.support.orm.utils.ClassUtil;
import com.lfd.soa.srv.demo.support.orm.utils.PageUtil;
import com.lfd.soa.srv.demo.support.orm.utils.ResultSetUtil;
    ...
    public <T> PageResult<T> page(ConditionParam param, Class<T> clazz) throws Exception{
        ...
        try {
            ...
            if (param.getPageNo() > totalPage) {
                throw new BusinessException("当前查询页数超过最大页数，pageNo：" + param.getPageNo() + "，totalPage：" + totalPage);
            }
